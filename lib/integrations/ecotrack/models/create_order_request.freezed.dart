...
int get hashCode {
  final _this = this as EcotrackOrderCreateRequest;
  return Object.hashAll([runtimeType,_this.reference,_this.nomClient,_this.telephone,_this.telephone2,_this.adresse,_this.codePostal,_this.commune,_this.codeWilaya,_this.montant,_this.remarque,_this.produit,_this.stock,_this.quantite,_this.produitARecuperer,_this.boutique,_this.type,_this.stopDesk,_this.weight,_this.fragile,_this.canOpen]);
}

@override
String toString() {
  final _this = this as EcotrackOrderCreateRequest;
  return 'EcotrackOrderCreateRequest(reference: ${_this.reference}, nomClient: ${_this.nomClient}, telephone: ${_this.telephone}, telephone2: ${_this.telephone2}, adresse: ${_this.adresse}, codePostal: ${_this.codePostal}, commune: ${_this.commune}, codeWilaya: ${_this.codeWilaya}, montant: ${_this.montant}, remarque: ${_this.remarque}, produit: ${_this.produit}, stock: ${_this.stock}, quantite: ${_this.quantite}, produitARecuperer: ${_this.produitARecuperer}, boutique: ${_this.boutique}, type: ${_this.type}, stopDesk: ${_this.stopDesk}, weight: ${_this.weight}, fragile: ${_this.fragile}, canOpen: ${_this.canOpen})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,reference,nomClient,telephone,telephone2,adresse,codePostal,commune,codeWilaya,montant,remarque,produit,stock,quantite,produitARecuperer,boutique,type,stopDesk,weight,fragile,canOpen]);
}
