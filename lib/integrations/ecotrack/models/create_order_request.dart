...
@freezed
abstract class EcotrackOrderCreateRequest with _$EcotrackOrderCreateRequest {
  const EcotrackOrderCreateRequest._();
  const factory EcotrackOrderCreateRequest({
  ...
  }) = _EcotrackOrderCreateRequest;

  factory EcotrackOrderCreateRequest.fromJson(Map<String, dynamic> json) =>
      _$EcotrackOrderCreateRequestFromJson(json);
}
