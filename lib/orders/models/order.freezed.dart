...
mixin _$Order {
 ...
 String? get cancelReason;/// Opencod v1 fields (identical API names).
 String? get statusId; String? get room; String? get kind; String? get closeAs; String? get cash; String? get stock; Map<String, dynamic>? get customFields;@JsonKey(fromJson: _storeFromJson, toJson: _storeToJson) Store? get store;@JsonKey(fromJson: _shippingMethodFromJson, toJson: _shippingMethodToJson) ShippingMethod? get shippingMethod;
...
int get hashCode {
  final _this = this as Order;
  return Object.hashAll([runtimeType,_this.id,_this.createdAt,_this.updatedAt,_this.scheduledAt,_this.effectiveAt,const DeepCollectionEquality().hash(_this.metadata),const DeepCollectionEquality().hash(_this.claims),const DeepCollectionEquality().hash(_this.references),_this.customerName,_this.customerPhone,_this.customerEmail,_this.customerNote,_this.customerIp,_this.internalNote,_this.shippingAddress,_this.shippingCity,_this.shippingState,_this.shippingCountry,_this.shippingMethodId,_this.shippingNote,_this.trackingCode,_this.paymentMethodId,_this.shippingType,const DeepCollectionEquality().hash(_this.tags),const DeepCollectionEquality().hash(_this.items),_this.subtotal,_this.shippingPrice,_this.total,_this.calculatedTotal,_this.manualTotal,_this.discount,_this.coupon,_this.storeId,_this.source,_this.confirmerId,_this.status,_this.paymentStatus,_this.deliveryStatus,_this.customStatus,_this.cancelReason,_this.statusId,_this.room,_this.kind,_this.closeAs,_this.cash,_this.stock,const DeepCollectionEquality().hash(_this.customFields),_this.store,_this.shippingMethod]);
}

@override
String toString() {
  final _this = this as Order;
  return 'Order(id: ${_this.id}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, scheduledAt: ${_this.scheduledAt}, effectiveAt: ${_this.effectiveAt}, metadata: ${_this.metadata}, claims: ${_this.claims}, references: ${_this.references}, customerName: ${_this.customerName}, customerPhone: ${_this.customerPhone}, customerEmail: ${_this.customerEmail}, customerNote: ${_this.customerNote}, customerIp: ${_this.customerIp}, internalNote: ${_this.internalNote}, shippingAddress: ${_this.shippingAddress}, shippingCity: ${_this.shippingCity}, shippingState: ${_this.shippingState}, shippingCountry: ${_this.shippingCountry}, shippingMethodId: ${_this.shippingMethodId}, shippingNote: ${_this.shippingNote}, trackingCode: ${_this.trackingCode}, paymentMethodId: ${_this.paymentMethodId}, shippingType: ${_this.shippingType}, tags: ${_this.tags}, items: ${_this.items}, subtotal: ${_this.subtotal}, shippingPrice: ${_this.shippingPrice}, total: ${_this.total}, calculatedTotal: ${_this.calculatedTotal}, manualTotal: ${_this.manualTotal}, discount: ${_this.discount}, coupon: ${_this.coupon}, storeId: ${_this.storeId}, source: ${_this.source}, confirmerId: ${_this.confirmerId}, status: ${_this.status}, paymentStatus: ${_this.paymentStatus}, deliveryStatus: ${_this.deliveryStatus}, customStatus: ${_this.customStatus}, cancelReason: ${_this.cancelReason}, statusId: ${_this.statusId}, room: ${_this.room}, kind: ${_this.kind}, closeAs: ${_this.closeAs}, cash: ${_this.cash}, stock: ${_this.stock}, customFields: ${_this.customFields}, store: ${_this.store}, shippingMethod: ${_this.shippingMethod})';
}
...
@useResult
$Res call({
 String id, DateTime createdAt, DateTime updatedAt, DateTime? scheduledAt, DateTime? effectiveAt, Map<String, dynamic> metadata, Map<String, dynamic>? claims, List<String> references, String? customerName, String? customerPhone, String? customerEmail, String? customerNote, String? customerIp, String? internalNote, String? shippingAddress, String? shippingCity, String? shippingState, String? shippingCountry, String? shippingMethodId, String? shippingNote, String? trackingCode, String? paymentMethodId,@JsonKey(fromJson: shippingTypeFromJson, toJson: shippingTypeToJson) ShippingType shippingType, List<String> tags, List<OrderItem> items, num subtotal, num? shippingPrice, num total, num calculatedTotal, num? manualTotal, num discount, String? coupon, String storeId, String? source, String? confirmerId, OrderStatus status, PaymentStatus paymentStatus, DeliveryStatus deliveryStatus, String? customStatus, String? cancelReason, String? statusId, String? room, String? kind, String? closeAs, String? cash, String? stock, Map<String, dynamic>? customFields,@JsonKey(fromJson: _storeFromJson, toJson: _storeToJson) Store? store,@JsonKey(fromJson: _shippingMethodFromJson, toJson: _shippingMethodToJson) ShippingMethod? shippingMethod
});
...
as DateTime?,effectiveAt: freezed == effectiveAt ? _self.effectiveAt : effectiveAt // ignore: cast_nullable_to_non_nullable
as DateTime?,metadata: null == metadata ? _self.metadata : metadata // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>,claims: freezed == claims ? _self.claims : claims // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,references: null == references ? _self.references : references // ignore: cast_nullable_to_non_nullable
...
as String?,closeAs: freezed == closeAs ? _self.closeAs : closeAs // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Order() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.scheduledAt,_that.effectiveAt,_that.metadata,_that.claims,_that.references,_that.customerName,_that.customerPhone,_that.customerEmail,_that.customerNote,_that.customerIp,_that.internalNote,_that.shippingAddress,_that.shippingCity,_that.shippingState,_that.shippingCountry,_that.shippingMethodId,_that.shippingNote,_that.trackingCode,_that.paymentMethodId,_that.shippingType,_that.tags,_that.items,_that.subtotal,_that.shippingPrice,_that.total,_that.calculatedTotal,_that.manualTotal,_that.discount,_that.coupon,_that.storeId,_that.source,_that.confirmerId,_that.status,_that.paymentStatus,_that.deliveryStatus,_that.customStatus,_that.cancelReason,_that.statusId,_that.room,_that.kind,_that.closeAs,_that.cash,_that.stock,_that.customFields,_that.store,_that.shippingMethod);case _:
  return orElse();
...
@override@JsonKey(fromJson: shippingTypeFromJson, toJson: shippingTypeToJson) final  ShippingType shippingType;
...
as Map<String, dynamic>,claims: freezed == claims ? _self._claims : claims // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,references: null == references ? _self._references : references // ignore: cast_nullable_to_non_nullable
as List<String>,customerName: freezed == customerName ? _self.customerName : customerName // ignore: cast_nullable_to_non_nullable
as String?,customerPhone: freezed == customerPhone ? _self.customerPhone : customerPhone // ignore: cast_nullable_to_non_nullable
as String?,customerEmail: freezed == customerEmail ? _self.customerEmail : customerEmail // ignore: cast_nullable_to_non_nullable
as String?,customerNote: freezed == customerNote ? _self.customerNote : customerNote // ignore: cast_nullable_to_non_nullable
...
@override
bool operator ==(Object other) {
  final _this = this as OrderCreate;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderCreate&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.customerName, _this.customerName) || other.customerName == _this.customerName)&&(identical(other.shippingNote, _this.shippingNote) || other.shippingNote == _this.shippingNote)&&(identical(other.customerPhone, _this.customerPhone) || other.customerPhone == _this.customerPhone)&&(identical(other.customerEmail, _this.customerEmail) || other.customerEmail == _this.customerEmail)&&(identical(other.customerNote, _this.customerNote) || other.customerNote == _this.customerNote)&&(identical(other.customerIp, _this.customerIp) || other.customerIp == _this.customerIp)&&(identical(other.shippingAddress, _this.shippingAddress) || other.shippingAddress == _this.shippingAddress)&&(identical(other.shippingCity, _this.shippingCity) || other.shippingCity == _this.shippingCity)&&(identical(other.shippingState, _this.shippingState) || other.shippingState == _this.shippingState)&&(identical(other.shippingCountry, _this.shippingCountry) || other.shippingCountry == _this.shippingCountry)&&(identical(other.shippingType, _this.shippingType) || other.shippingType == _this.shippingType)&&(identical(other.shippingMethodId, _this.shippingMethodId) || other.shippingMethodId == _this.shippingMethodId)&&(identical(other.trackingCode, _this.trackingCode) || other.trackingCode == _this.trackingCode)&&(identical(other.paymentMethodId, _this.paymentMethodId) || other.paymentMethodId == _this.paymentMethodId)&&const DeepCollectionEquality().equals(other.items, _this.items)&&(identical(other.internalNote, _this.internalNote) || other.internalNote == _this.internalNote)&&const DeepCollectionEquality().equals(other.tags, _this.tags)&&(identical(other.subtotal, _this.subtotal) || other.subtotal == _this.subtotal)&&(identical(other.shippingPrice, _this.shippingPrice) || other.shippingPrice == _this.shippingPrice)&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.manualTotal, _this.manualTotal) || other.manualTotal == _this.manualTotal)&&(identical(other.discount, _this.discount) || other.discount == _this.discount)&&(identical(other.coupon, _this.coupon) || other.coupon == _this.coupon)&&(identical(other.storeId, _this.storeId) || other.storeId == _this.storeId)&&(identical(other.source, _this.source) || other.source == _this.source)&&(identical(other.status, _this.status) || other.status == _this.status)&&(identical(other.paymentStatus, _this.paymentStatus) || other.paymentStatus == _this.paymentStatus)&&(identical(other.deliveryStatus, _this.deliveryStatus) || other.deliveryStatus == _this.deliveryStatus)&&const DeepCollectionEquality().equals(other.customFields, _this.customFields)&&const DeepCollectionEquality().equals(other.metadata, _this.metadata)&&const DeepCollectionEquality().equals(other.references, _this.references)&&(identical(other.scheduledAt, _this.scheduledAt) || other.scheduledAt == _this.scheduledAt));
}
...
int get hashCode {
  final _this = this as OrderCreate;
  return Object.hashAll([runtimeType,_this.id,_this.customerName,_this.shippingNote,_this.customerPhone,_this.customerEmail,_this.customerNote,_this.customerIp,_this.shippingAddress,_this.shippingCity,_this.shippingState,_this.shippingCountry,_this.shippingType,_this.shippingMethodId,_this.trackingCode,_this.paymentMethodId,const DeepCollectionEquality().hash(_this.items),_this.internalNote,const DeepCollectionEquality().hash(_this.tags),_this.subtotal,_this.shippingPrice,_this.total,_this.manualTotal,_this.discount,_this.coupon,_this.storeId,_this.source,_this.status,_this.paymentStatus,_this.deliveryStatus,const DeepCollectionEquality().hash(_this.customFields),const DeepCollectionEquality().hash(_this.metadata),const DeepCollectionEquality().hash(_this.references),_this.scheduledAt]);
}

@override
String toString() {
  final _this = this as OrderCreate;
  return 'OrderCreate(id: ${_this.id}, customerName: ${_this.customerName}, shippingNote: ${_this.shippingNote}, customerPhone: ${_this.customerPhone}, customerEmail: ${_this.customerEmail}, customerNote: ${_this.customerNote}, customerIp: ${_this.customerIp}, shippingAddress: ${_this.shippingAddress}, shippingCity: ${_this.shippingCity}, shippingState: ${_this.shippingState}, shippingCountry: ${_this.shippingCountry}, shippingType: ${_this.shippingType}, shippingMethodId: ${_this.shippingMethodId}, trackingCode: ${_this.trackingCode}, paymentMethodId: ${_this.paymentMethodId}, items: ${_this.items}, internalNote: ${_this.internalNote}, tags: ${_this.tags}, subtotal: ${_this.subtotal}, shippingPrice: ${_this.shippingPrice}, total: ${_this.total}, manualTotal: ${_this.manualTotal}, discount: ${_this.discount}, coupon: ${_this.coupon}, storeId: ${_this.storeId}, source: ${_this.source}, status: ${_this.status}, paymentStatus: ${_this.paymentStatus}, deliveryStatus: ${_this.deliveryStatus}, customFields: ${_this.customFields}, metadata: ${_this.metadata}, references: ${_this.references}, scheduledAt: ${_this.scheduledAt})';
}
...
@useResult
$Res call({
 String? id, String? customerName, String? shippingNote, String? customerPhone, String? customerEmail, String? customerNote, String? customerIp, String? shippingAddress, String? shippingCity, String? shippingState, String? shippingCountry,@JsonKey(fromJson: shippingTypeNullableFromJson, toJson: shippingTypeNullableToJson) ShippingType? shippingType, String? shippingMethodId, String? trackingCode, String? paymentMethodId, List<OrderItem> items, String? internalNote, List<String>? tags, num? subtotal, num? shippingPrice, num? total, num? manualTotal, num? discount, String? coupon, String storeId, String? source, OrderStatus? status, PaymentStatus? paymentStatus, DeliveryStatus? deliveryStatus, Map<String, dynamic>? customFields, Map<String, dynamic>? metadata, List<String>? references, DateTime? scheduledAt
});
...
as Map<String, dynamic>?,references: freezed == references ? _self.references : references // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? customerName,  String? shippingNote,  String? customerPhone,  String? customerEmail,  String? customerNote,  String? customerIp,  String? shippingAddress,  String? shippingCity,  String? shippingState,  String? shippingCountry, @JsonKey(fromJson: shippingTypeNullableFromJson, toJson: shippingTypeNullableToJson)  ShippingType? shippingType,  String? shippingMethodId,  String? trackingCode,  String? paymentMethodId,  List<OrderItem> items,  String? internalNote,  List<String>? tags,  num? subtotal,  num? shippingPrice,  num? total,  num? manualTotal,  num? discount,  String? coupon,  String storeId,  String? source,  OrderStatus? status,  PaymentStatus? paymentStatus,  DeliveryStatus? deliveryStatus,  Map<String, dynamic>? customFields,  Map<String, dynamic>? metadata,  List<String>? references,  DateTime? scheduledAt)  $default,) {final _that = this;
switch (_that) {
case _OrderCreate():
return $default(_that.id,_that.customerName,_that.shippingNote,_that.customerPhone,_that.customerEmail,_that.customerNote,_that.customerIp,_that.shippingAddress,_that.shippingCity,_that.shippingState,_that.shippingCountry,_that.shippingType,_that.shippingMethodId,_that.trackingCode,_that.paymentMethodId,_that.items,_that.internalNote,_that.tags,_that.subtotal,_that.shippingPrice,_that.total,_that.manualTotal,_that.discount,_that.coupon,_that.storeId,_that.source,_that.status,_that.paymentStatus,_that.deliveryStatus,_that.customFields,_that.metadata,_that.references,_that.scheduledAt);case _:
  throw StateError('Unexpected subclass');
...
@override final  String? shippingState;
@override final  String? shippingCountry;
@override@JsonKey(fromJson: shippingTypeNullableFromJson, toJson: shippingTypeNullableToJson) final  ShippingType? shippingType;
@override final  String? shippingMethodId;
@override final  String? trackingCode;
@override final  String? paymentMethodId;
 final  List<OrderItem> _items;
...
as Map<String, dynamic>?,references: freezed == references ? _self._references : references // ignore: cast_nullable_to_non_nullable
as List<String>?,scheduledAt: freezed == scheduledAt ? _self.scheduledAt : scheduledAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
@override
bool operator ==(Object other) {
  final _this = this as OrderUpdate;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderUpdate&&(identical(other.customerName, _this.customerName) || other.customerName == _this.customerName)&&(identical(other.shippingNote, _this.shippingNote) || other.shippingNote == _this.shippingNote)&&(identical(other.customerPhone, _this.customerPhone) || other.customerPhone == _this.customerPhone)&&(identical(other.customerEmail, _this.customerEmail) || other.customerEmail == _this.customerEmail)&&(identical(other.customerNote, _this.customerNote) || other.customerNote == _this.customerNote)&&(identical(other.customerIp, _this.customerIp) || other.customerIp == _this.customerIp)&&(identical(other.shippingAddress, _this.shippingAddress) || other.shippingAddress == _this.shippingAddress)&&(identical(other.shippingCity, _this.shippingCity) || other.shippingCity == _this.shippingCity)&&(identical(other.shippingState, _this.shippingState) || other.shippingState == _this.shippingState)&&(identical(other.shippingCountry, _this.shippingCountry) || other.shippingCountry == _this.shippingCountry)&&(identical(other.shippingType, _this.shippingType) || other.shippingType == _this.shippingType)&&(identical(other.shippingMethodId, _this.shippingMethodId) || other.shippingMethodId == _this.shippingMethodId)&&(identical(other.trackingCode, _this.trackingCode) || other.trackingCode == _this.trackingCode)&&(identical(other.paymentMethodId, _this.paymentMethodId) || other.paymentMethodId == _this.paymentMethodId)&&const DeepCollectionEquality().equals(other.items, _this.items)&&(identical(other.subtotal, _this.subtotal) || other.subtotal == _this.subtotal)&&(identical(other.shippingPrice, _this.shippingPrice) || other.shippingPrice == _this.shippingPrice)&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.manualTotal, _this.manualTotal) || other.manualTotal == _this.manualTotal)&&(identical(other.discount, _this.discount) || other.discount == _this.discount)&&(identical(other.coupon, _this.coupon) || other.coupon == _this.coupon)&&(identical(other.source, _this.source) || other.source == _this.source)&&(identical(other.internalNote, _this.internalNote) || other.internalNote == _this.internalNote)&&const DeepCollectionEquality().equals(other.tags, _this.tags)&&(identical(other.storeId, _this.storeId) || other.storeId == _this.storeId)&&(identical(other.status, _this.status) || other.status == _this.status)&&(identical(other.paymentStatus, _this.paymentStatus) || other.paymentStatus == _this.paymentStatus)&&(identical(other.deliveryStatus, _this.deliveryStatus) || other.deliveryStatus == _this.deliveryStatus)&&(identical(other.customStatus, _this.customStatus) || other.customStatus == _this.customStatus)&&(identical(other.cancelReason, _this.cancelReason) || other.cancelReason == _this.cancelReason)&&const DeepCollectionEquality().equals(other.customFields, _this.customFields)&&const DeepCollectionEquality().equals(other.metadata, _this.metadata)&&const DeepCollectionEquality().equals(other.references, _this.references)&&(identical(other.scheduledAt, _this.scheduledAt) || other.scheduledAt == _this.scheduledAt)&&const DeepCollectionEquality().equals(other.setToNull, _this.setToNull));
}
...
int get hashCode {
  final _this = this as OrderUpdate;
  return Object.hashAll([runtimeType,_this.customerName,_this.shippingNote,_this.customerPhone,_this.customerEmail,_this.customerNote,_this.customerIp,_this.shippingAddress,_this.shippingCity,_this.shippingState,_this.shippingCountry,_this.shippingType,_this.shippingMethodId,_this.trackingCode,_this.paymentMethodId,const DeepCollectionEquality().hash(_this.items),_this.subtotal,_this.shippingPrice,_this.total,_this.manualTotal,_this.discount,_this.coupon,_this.source,_this.internalNote,const DeepCollectionEquality().hash(_this.tags),_this.storeId,_this.status,_this.paymentStatus,_this.deliveryStatus,_this.customStatus,_this.cancelReason,const DeepCollectionEquality().hash(_this.customFields),const DeepCollectionEquality().hash(_this.metadata),const DeepCollectionEquality().hash(_this.references),_this.scheduledAt,const DeepCollectionEquality().hash(_this.setToNull)]);
}

@override
String toString() {
  final _this = this as OrderUpdate;
  return 'OrderUpdate(customerName: ${_this.customerName}, shippingNote: ${_this.shippingNote}, customerPhone: ${_this.customerPhone}, customerEmail: ${_this.customerEmail}, customerNote: ${_this.customerNote}, customerIp: ${_this.customerIp}, shippingAddress: ${_this.shippingAddress}, shippingCity: ${_this.shippingCity}, shippingState: ${_this.shippingState}, shippingCountry: ${_this.shippingCountry}, shippingType: ${_this.shippingType}, shippingMethodId: ${_this.shippingMethodId}, trackingCode: ${_this.trackingCode}, paymentMethodId: ${_this.paymentMethodId}, items: ${_this.items}, subtotal: ${_this.subtotal}, shippingPrice: ${_this.shippingPrice}, total: ${_this.total}, manualTotal: ${_this.manualTotal}, discount: ${_this.discount}, coupon: ${_this.coupon}, source: ${_this.source}, internalNote: ${_this.internalNote}, tags: ${_this.tags}, storeId: ${_this.storeId}, status: ${_this.status}, paymentStatus: ${_this.paymentStatus}, deliveryStatus: ${_this.deliveryStatus}, customStatus: ${_this.customStatus}, cancelReason: ${_this.cancelReason}, customFields: ${_this.customFields}, metadata: ${_this.metadata}, references: ${_this.references}, scheduledAt: ${_this.scheduledAt}, setToNull: ${_this.setToNull})';
}
...
@useResult
$Res call({
 String? customerName, String? shippingNote, String? customerPhone, String? customerEmail, String? customerNote, String? customerIp, String? shippingAddress, String? shippingCity, String? shippingState, String? shippingCountry,@JsonKey(fromJson: shippingTypeNullableFromJson, toJson: shippingTypeNullableToJson) ShippingType? shippingType, String? shippingMethodId, String? trackingCode, String? paymentMethodId, List<OrderItem>? items, num? subtotal, num? shippingPrice, num? total, num? manualTotal, num? discount, String? coupon, String? source, String? internalNote, List<String>? tags, String storeId, OrderStatus? status, PaymentStatus? paymentStatus, DeliveryStatus? deliveryStatus, String? customStatus, String? cancelReason, Map<String, dynamic>? customFields, Map<String, dynamic>? metadata, List<String>? references, DateTime? scheduledAt,@JsonKey(includeFromJson: false) List<String> setToNull
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? customerName,  String? shippingNote,  String? customerPhone,  String? customerEmail,  String? customerNote,  String? customerIp,  String? shippingAddress,  String? shippingCity,  String? shippingState,  String? shippingCountry, @JsonKey(fromJson: shippingTypeNullableFromJson, toJson: shippingTypeNullableToJson)  ShippingType? shippingType,  String? shippingMethodId,  String? trackingCode,  String? paymentMethodId,  List<OrderItem>? items,  num? subtotal,  num? shippingPrice,  num? total,  num? manualTotal,  num? discount,  String? coupon,  String? source,  String? internalNote,  List<String>? tags,  String storeId,  OrderStatus? status,  PaymentStatus? paymentStatus,  DeliveryStatus? deliveryStatus,  String? customStatus,  String? cancelReason,  Map<String, dynamic>? customFields,  Map<String, dynamic>? metadata,  List<String>? references,  DateTime? scheduledAt, @JsonKey(includeFromJson: false)  List<String> setToNull)  $default,) {final _that = this;
switch (_that) {
case _OrderUpdate():
return $default(_that.customerName,_that.shippingNote,_that.customerPhone,_that.customerEmail,_that.customerNote,_that.customerIp,_that.shippingAddress,_that.shippingCity,_that.shippingState,_that.shippingCountry,_that.shippingType,_that.shippingMethodId,_that.trackingCode,_that.paymentMethodId,_that.items,_that.subtotal,_that.shippingPrice,_that.total,_that.manualTotal,_that.discount,_that.coupon,_that.source,_that.internalNote,_that.tags,_that.storeId,_that.status,_that.paymentStatus,_that.deliveryStatus,_that.customStatus,_that.cancelReason,_that.customFields,_that.metadata,_that.references,_that.scheduledAt,_that.setToNull);case _:
  throw StateError('Unexpected subclass');
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderUpdate&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.shippingNote, shippingNote) || other.shippingNote == shippingNote)&&(identical(other.customerPhone, customerPhone) || other.customerPhone == customerPhone)&&(identical(other.customerEmail, customerEmail) || other.customerEmail == customerEmail)&&(identical(other.customerNote, customerNote) || other.customerNote == customerNote)&&(identical(other.customerIp, customerIp) || other.customerIp == customerIp)&&(identical(other.shippingAddress, shippingAddress) || other.shippingAddress == shippingAddress)&&(identical(other.shippingCity, shippingCity) || other.shippingCity == shippingCity)&&(identical(other.shippingState, shippingState) || other.shippingState == shippingState)&&(identical(other.shippingCountry, shippingCountry) || other.shippingCountry == shippingCountry)&&(identical(other.shippingType, shippingType) || other.shippingType == shippingType)&&(identical(other.shippingMethodId, shippingMethodId) || other.shippingMethodId == shippingMethodId)&&(identical(other.trackingCode, trackingCode) || other.trackingCode == trackingCode)&&(identical(other.paymentMethodId, paymentMethodId) || other.paymentMethodId == paymentMethodId)&&const DeepCollectionEquality().equals(other.items, _items)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.shippingPrice, shippingPrice) || other.shippingPrice == shippingPrice)&&(identical(other.total, total) || other.total == total)&&(identical(other.manualTotal, manualTotal) || other.manualTotal == manualTotal)&&(identical(other.discount, discount) || other.discount == discount)&&(identical(other.coupon, coupon) || other.coupon == coupon)&&(identical(other.source, source) || other.source == source)&&(identical(other.internalNote, internalNote) || other.internalNote == internalNote)&&const DeepCollectionEquality().equals(other.tags, _tags)&&(identical(other.storeId, storeId) || other.storeId == storeId)&&(identical(other.status, status) || other.status == status)&&(identical(other.paymentStatus, paymentStatus) || other.paymentStatus == paymentStatus)&&(identical(other.deliveryStatus, deliveryStatus) || other.deliveryStatus == deliveryStatus)&&(identical(other.customStatus, customStatus) || other.customStatus == customStatus)&&(identical(other.cancelReason, cancelReason) || other.cancelReason == cancelReason)&&const DeepCollectionEquality().equals(other.customFields, _customFields)&&const DeepCollectionEquality().equals(other.metadata, _metadata)&&const DeepCollectionEquality().equals(other.references, _references)&&(identical(other.scheduledAt, scheduledAt) || other.scheduledAt == scheduledAt)&&const DeepCollectionEquality().equals(other.setToNull, _setToNull));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hashAll([runtimeType,customerName,shippingNote,customerPhone,customerEmail,customerNote,customerIp,shippingAddress,shippingCity,shippingState,shippingCountry,shippingType,shippingMethodId,trackingCode,paymentMethodId,const DeepCollectionEquality().hash(_items),subtotal,shippingPrice,total,manualTotal,discount,coupon,source,internalNote,const DeepCollectionEquality().hash(_tags),storeId,status,paymentStatus,deliveryStatus,customStatus,cancelReason,const DeepCollectionEquality().hash(_customFields),const DeepCollectionEquality().hash(_metadata),const DeepCollectionEquality().hash(_references),scheduledAt,const DeepCollectionEquality().hash(_setToNull)]);
}

@override
String toString() {
    return 'OrderUpdate(customerName: $customerName, shippingNote: $shippingNote, customerPhone: $customerPhone, customerEmail: $customerEmail, customerNote: $customerNote, customerIp: $customerIp, shippingAddress: $shippingAddress, shippingCity: $shippingCity, shippingState: $shippingState, shippingCountry: $shippingCountry, shippingType: $shippingType, shippingMethodId: $shippingMethodId, trackingCode: $trackingCode, paymentMethodId: $paymentMethodId, items: $items, subtotal: $subtotal, shippingPrice: $shippingPrice, total: $total, manualTotal: $manualTotal, discount: $discount, coupon: $coupon, source: $source, internalNote: $internalNote, tags: $tags, storeId: $storeId, status: $status, paymentStatus: $paymentStatus, deliveryStatus: $deliveryStatus, customStatus: $customStatus, cancelReason: $cancelReason, customFields: $customFields, metadata: $metadata, references: $references, scheduledAt: $scheduledAt, setToNull: $setToNull)';
}
...
@override
bool operator ==(Object other) {
  final _this = this as OrderHistoryEvent;
...
int get hashCode {
  final _this = this as OrderHistoryEvent;
  return Object.hash(runtimeType,_this.createdAt,_this.status,_this.deliveryStatus,_this.paymentStatus,_this.message,_this.code,_this.userId);
}

@override
String toString() {
  final _this = this as OrderHistoryEvent;
  return 'OrderHistoryEvent(createdAt: ${_this.createdAt}, status: ${_this.status}, deliveryStatus: ${_this.deliveryStatus}, paymentStatus: ${_this.paymentStatus}, message: ${_this.message}, code: ${_this.code}, userId: ${_this.userId})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,createdAt,status,deliveryStatus,paymentStatus,message,code,userId);
}
