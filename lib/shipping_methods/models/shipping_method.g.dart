...
_ShippingMethodCreate _$ShippingMethodCreateFromJson(
...
Map<String, dynamic> _$ShippingMethodCreateToJson(
  _ShippingMethodCreate instance,
) => <String, dynamic>{
  'id': instance.id,
  'metadata': instance.metadata,
  'name': instance.name,
...
_ShippingMethodUpdate _$ShippingMethodUpdateFromJson(
  Map<String, dynamic> json,
  ...
  rates: (json['rates'] as List<dynamic>?)
      ?.map((e) => (e as List<dynamic>?)?.map((e) => e as num?).toList())
      .toList(),
  status: $enumDecodeNullable(_$ShippingMethodStatusEnumMap, json['status']),
  policy: $enumDecodeNullable(_$ShippingMethodPolicyEnumMap, json['policy']),
);

Map<String, dynamic> _$ShippingMethodUpdateToJson(
  _ShippingMethodUpdate instance,
) => <String, dynamic>{
  'metadata': instance.metadata,
  'name': instance.name,
  'description': instance.description,
