...
class _OrderCreate implements OrderCreate {
  const _OrderCreate({this.id, this.customerName, this.shippingNote, this.customerPhone, this.customerEmail, this.customerNote, this.customerIp, this.shippingAddress, this.shippingCity, this.shippingState, this.shippingCountry, @JsonKey(fromJson: shippingTypeNullableFromJson, toJson: shippingTypeNullableToJson) this.shippingType, this.shippingMethodId, this.trackingCode, this.paymentMethodId, required final  List<OrderItem> items, this.internalNote, final  List<String>? tags, this.subtotal, this.shippingPrice, this.total, this.manualTotal, this.discount, this.coupon, required this.storeId, this.source, this.status, this.paymentStatus, this.deliveryStatus, final  Map<String, dynamic>? customFields, final  Map<String, dynamic>? metadata, final  List<String>? references, this.scheduledAt}): _items = items,_tags = tags,_customFields = customFields,_metadata = metadata,_references = references;
...
class _OrderUpdate implements OrderUpdate {
  const _OrderUpdate({this.customerName, this.shippingNote, this.customerPhone, this.customerEmail, this.customerNote, this.customerIp, this.shippingAddress, this.shippingCity, this.shippingState, this.shippingCountry, @JsonKey(fromJson: shippingTypeNullableFromJson, toJson: shippingTypeNullableToJson) this.shippingType, this.shippingMethodId, this.trackingCode, this.paymentMethodId, final  List<OrderItem>? items, this.subtotal, this.shippingPrice, this.total, this.manualTotal, this.discount, this.coupon, this.source, this.internalNote, final  List<String>? tags, required this.storeId, this.status, this.paymentStatus, this.deliveryStatus, this.customStatus, this.cancelReason, final  Map<String, dynamic>? customFields, final  Map<String, dynamic>? metadata, final  List<String>? references, this.scheduledAt, @JsonKey(includeFromJson: false) final  List<String> setToNull = const []}): _items = items,_tags = tags,_customFields = customFields,_metadata = metadata,_references = references,_setToNull = setToNull;
