...
_EcotrackOrderCreateRequest _$EcotrackOrderCreateRequestFromJson(
...
Map<String, dynamic> _$EcotrackOrderCreateRequestToJson(
  _EcotrackOrderCreateRequest instance,
) => <String, dynamic>{
