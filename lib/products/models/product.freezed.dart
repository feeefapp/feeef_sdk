...
@JsonKey(fromJson: _productLorFromJson, toJson: _productLorToJson) LiteOrdersReport? get lor;
...
as String?,shippingFeeId: freezed == shippingFeeId ? _self.shippingFeeId : shippingFeeId // ignore: cast_nullable_to_non_nullable
...
as List<ProductOffer>?,forceOffer: freezed == forceOffer ? _self.forceOffer : forceOffer // ignore: cast_nullable_to_non_nullable
as bool?,defaultOfferCode: freezed == defaultOfferCode ? _self.defaultOfferCode : defaultOfferCode // ignore: cast_nullable_to_non_nullable
as String?,addons: freezed == addons ? _self.addons : addons // ignore: cast_nullable_to_non_nullable
...
/// [defaultOfferCode], that offer is locked.
@override final  bool? forceOffer;
/// Offer code to preselect; synced to null when missing from [offers].
@override final  String? defaultOfferCode;
...
@override@JsonKey(fromJson: _productLorFromJson, toJson: _productLorToJson) final  LiteOrdersReport? lor;
...
as List<ProductOffer>?,forceOffer: freezed == forceOffer ? _self.forceOffer : forceOffer // ignore: cast_nullable_to_non_nullable
as bool?,defaultOfferCode: freezed == defaultOfferCode ? _self.defaultOfferCode : defaultOfferCode // ignore: cast_nullable_to_non_nullable
as String?,addons: freezed == addons ? _self._addons : addons // ignore: cast_nullable_to_non_nullable
as List<ProductAddon>?,dislikes: null == dislikes ? _self.dislikes : dislikes // ignore: cast_nullable_to_non_nullable
as num,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as ProductStatus,type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as ProductType,integrationsData: freezed == integrationsData ? _self.integrationsData : integrationsData // ignore: cast_nullable_to_non_nullable
...
class _ProductUpdate implements ProductUpdate {
  const _ProductUpdate({this.name, this.slug, this.decoration, this.photoUrl,  List<String>? media, this.storeId, this.shippingMethodId, this.shippingFeeId, this.categoryId, this.category, this.title, this.description, this.body, this.sku, this.barcode, this.price, this.cost, this.discount, this.stock, this.variant,  List<ProductOffer>? offers, this.forceOffer, this.defaultOfferCode,  List<ProductAddon>? addons, this.integrationsData, this.status, this.type,  Map<String, dynamic>? metadata, @JsonKey(includeFromJson: false)  List<String> setToNull = const []}): _media = media,_offers = offers,_addons = addons,_metadata = metadata,_setToNull = setToNull;
