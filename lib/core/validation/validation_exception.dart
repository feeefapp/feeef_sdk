...
@freezed
abstract class FeeefValidationException
    with _$FeeefValidationException
    implements Exception {
  factory FeeefValidationException({required List<FeeefViolation> errors}) =
      _FeeefValidationException;

  factory FeeefValidationException.fromJson(Map<String, dynamic> json) =>
      _$FeeefValidationExceptionFromJson(json);
}

@freezed
abstract class FeeefViolation with _$FeeefViolation {
  ...
  factory FeeefViolation.fromJson(Map<String, dynamic> json) =>
      _$FeeefViolationFromJson(json);
}
