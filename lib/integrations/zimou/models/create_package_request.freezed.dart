...
int get hashCode {
  final _this = this as ZimouPackageCreateRequest;
  return Object.hashAll([runtimeType,_this.type,_this.warehouseId,_this.name,_this.clientLastName,_this.clientFirstName,_this.clientPhone,_this.clientPhone2,_this.address,_this.orderId,_this.price,_this.freeDelivery,_this.quantityItems,_this.deliveryType,_this.wilaya,_this.commune,_this.officeId,_this.canBeOpened,_this.observation,_this.returnedProduct,_this.weight]);
}

@override
String toString() {
  final _this = this as ZimouPackageCreateRequest;
  return 'ZimouPackageCreateRequest(type: ${_this.type}, warehouseId: ${_this.warehouseId}, name: ${_this.name}, clientLastName: ${_this.clientLastName}, clientFirstName: ${_this.clientFirstName}, clientPhone: ${_this.clientPhone}, clientPhone2: ${_this.clientPhone2}, address: ${_this.address}, orderId: ${_this.orderId}, price: ${_this.price}, freeDelivery: ${_this.freeDelivery}, quantityItems: ${_this.quantityItems}, deliveryType: ${_this.deliveryType}, wilaya: ${_this.wilaya}, commune: ${_this.commune}, officeId: ${_this.officeId}, canBeOpened: ${_this.canBeOpened}, observation: ${_this.observation}, returnedProduct: ${_this.returnedProduct}, weight: ${_this.weight})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,type,warehouseId,name,clientLastName,clientFirstName,clientPhone,clientPhone2,address,orderId,price,freeDelivery,quantityItems,deliveryType,wilaya,commune,officeId,canBeOpened,observation,returnedProduct,weight]);
}
