...
bool operator ==(Object other) {
  final _this = this as YalidineOrderCreateRequest;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is YalidineOrderCreateRequest&&(identical(other.orderId, _this.orderId) || other.orderId == _this.orderId)&&(identical(other.fromWilayaName, _this.fromWilayaName) || other.fromWilayaName == _this.fromWilayaName)&&(identical(other.firstName, _this.firstName) || other.firstName == _this.firstName)&&(identical(other.familyName, _this.familyName) || other.familyName == _this.familyName)&&(identical(other.contactPhone, _this.contactPhone) || other.contactPhone == _this.contactPhone)&&(identical(other.address, _this.address) || other.address == _this.address)&&(identical(other.toCommuneName, _this.toCommuneName) || other.toCommuneName == _this.toCommuneName)&&(identical(other.toWilayaName, _this.toWilayaName) || other.toWilayaName == _this.toWilayaName)&&(identical(other.productList, _this.productList) || other.productList == _this.productList)&&(identical(other.price, _this.price) || other.price == _this.price)&&(identical(other.doInsurance, _this.doInsurance) || other.doInsurance == _this.doInsurance)&&(identical(other.declaredValue, _this.declaredValue) || other.declaredValue == _this.declaredValue)&&(identical(other.height, _this.height) || other.height == _this.height)&&(identical(other.width, _this.width) || other.width == _this.width)&&(identical(other.length, _this.length) || other.length == _this.length)&&(identical(other.weight, _this.weight) || other.weight == _this.weight)&&(identical(other.freeShipping, _this.freeShipping) || other.freeShipping == _this.freeShipping)&&(identical(other.isStopDesk, _this.isStopDesk) || other.isStopDesk == _this.isStopDesk)&&(identical(other.stopDeskId, _this.stopDeskId) || other.stopDeskId == _this.stopDeskId)&&(identical(other.hasExchange, _this.hasExchange) || other.hasExchange == _this.hasExchange)&&(identical(other.productToCollect, _this.productToCollect) || other.productToCollect == _this.productToCollect)&&(identical(other.stateCode, _this.stateCode) || other.stateCode == _this.stateCode)&&(identical(other.cityCode, _this.cityCode) || other.cityCode == _this.cityCode));
}
...
int get hashCode {
  final _this = this as YalidineOrderCreateRequest;
  return Object.hashAll([runtimeType,_this.orderId,_this.fromWilayaName,_this.firstName,_this.familyName,_this.contactPhone,_this.address,_this.toCommuneName,_this.toWilayaName,_this.productList,_this.price,_this.doInsurance,_this.declaredValue,_this.height,_this.width,_this.length,_this.weight,_this.freeShipping,_this.isStopDesk,_this.stopDeskId,_this.hasExchange,_this.productToCollect,_this.stateCode,_this.cityCode]);
}

@override
String toString() {
  final _this = this as YalidineOrderCreateRequest;
  return 'YalidineOrderCreateRequest(orderId: ${_this.orderId}, fromWilayaName: ${_this.fromWilayaName}, firstName: ${_this.firstName}, familyName: ${_this.familyName}, contactPhone: ${_this.contactPhone}, address: ${_this.address}, toCommuneName: ${_this.toCommuneName}, toWilayaName: ${_this.toWilayaName}, productList: ${_this.productList}, price: ${_this.price}, doInsurance: ${_this.doInsurance}, declaredValue: ${_this.declaredValue}, height: ${_this.height}, width: ${_this.width}, length: ${_this.length}, weight: ${_this.weight}, freeShipping: ${_this.freeShipping}, isStopDesk: ${_this.isStopDesk}, stopDeskId: ${_this.stopDeskId}, hasExchange: ${_this.hasExchange}, productToCollect: ${_this.productToCollect}, stateCode: ${_this.stateCode}, cityCode: ${_this.cityCode})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,orderId,fromWilayaName,firstName,familyName,contactPhone,address,toCommuneName,toWilayaName,productList,price,doInsurance,declaredValue,height,width,length,weight,freeShipping,isStopDesk,stopDeskId,hasExchange,productToCollect,stateCode,cityCode]);
}
